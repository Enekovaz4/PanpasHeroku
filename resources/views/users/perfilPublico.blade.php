                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               <img src="{{$user->avatar}}" id="avatar" class="img" alt="Foto de Perfil de {{$user->username}}">
                              <canvas id="graph_recetas" style="max-width: 60%; max-height: auto; display: inline-block; float: right;" alt="gráfico de todas las recetas que ha insertado {{ $user->username }}, separado por 12 meses."></canvas>
