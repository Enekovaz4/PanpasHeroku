            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link js-scroll-trigger @if (Request::path() == 'users/seguidos') active @endif" href="{{ route('user_seguidos') }}" title="Ir a la sección de Seguidos">
                                Seguidos <span class="badge badge-info text-white" title="Total de seguidos" id="nav_seguidos">{{ count(Auth::user()->follows) }}</span>
                            </a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link js-scroll-trigger @if (Request::path() == 'users/seguidores') active @endif" href="{{ route('user_seguidores') }}" title="Ir a la sección de Seguidores">
                        ...
                        <li class="nav-item p-2">
                            <a class="nav-link js-scroll-trigger @if (Request::path() == 'users/usuarios') active @endif" href="{{ route('user_usuarios') }}" title="Ir a la sección de Usuarios">Usuarios</a>
                        </li>
                        <li class="nav-item p-2">
                            <a class="nav-link js-scroll-trigger @if (Request::path() == 'users/recetas') active @endif" href="{{ route('user_recetas') }}" title="Ir a la sección de Recetas">Recetas</a>
                        </li>
                        {{--
